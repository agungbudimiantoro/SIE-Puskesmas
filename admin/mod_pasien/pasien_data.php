<h3 class="text-center">Input Data Pasien</h3>
<div class="row">
    <div class="col-md-3"></div>
    <div class="col-md-6">
        <form action="?p=pasien_import" enctype="multipart/form-data" method="POST">
            <div class="mb-3">
...
<table class="table align-items-center mb-0 display" id="table_id">
    ...
    <tbody>
        ...
        ?><tr>
                ...
                <td>
                    <a href="?p=pasien_edit&id=<?= $data['kode_pasien'] ?>" class="btn btn-warning">Ubah</a>
                    <a href="?p=pasien_proses&id=<?= $data['kode_pasien'] ?>" onclick="return confirm('anda yakin ingin menghapus data?')" class="btn btn-danger">Hapus</a>
                </td>
            </tr>
        <?php }; ?>
    </tbody>
...
<div class="d-flex bd-highlight mb-3">
    <div class="ms-auto p-2 bd-highlight">
        <a href="?p=pasien_tambah" class="btn btn-primary">Add</a>
        <a href="?p=pasien_data&clear" onclick="return confirm('anda yakin ingin menghapus semua data?')" name="clear" class="btn btn-danger">Delete</a>
...
<?php
if (isset($_GET['clear'])) {
    $sql = mysqli_query($conn, "TRUNCATE pasien");
    if ($sql) {
        echo "
